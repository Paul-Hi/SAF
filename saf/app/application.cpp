...
bool Application::init()
{
    ...
    // io.ConfigFlags |= ImGuiConfigFlags_ViewportsEnable;   // Enable Multi-Viewport / Platform Windows (disabled for now, since Wayland and GLFW do not like each other yet)
